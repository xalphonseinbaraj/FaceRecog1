...
from src.alphonse_collect_trainingdata.get_faces_from_camera import TrainingDataCollector
from src.alphonse_face_embedding.faces_embedding import GenerateFaceEmbedding
from src.alphonse_predictor.facePredictor import FacePredictor
from src.alphonse_training.train_softmax import TrainFaceRecogModel
...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        link2 = tk.Label(self.window, text="Copyright©2020, ISU-Depart.of IE", fg="blue", )
        link2.place(x=690, y=580)
        # link2.pack()
        link2.bind("<Button-1>", lambda e: self.callback("http://www.isu.edu.tw/pages/"))
